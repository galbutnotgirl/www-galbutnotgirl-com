...
module.exports = function TemplateManager() {
    ...
    TemplateManager.beforePublish = function (data, next) {
        ...
        try {
            ...
            scaffold = (scaffold && typeof scaffold == "boolean") ? scaffold : true;
            if (data.entry && (data.entry.url || (data.content_type.options && data.content_type.options.is_page)) && data.content_type && data.content_type.uid && data.content_type.schema && data.content_type.schema.length && scaffold) {
